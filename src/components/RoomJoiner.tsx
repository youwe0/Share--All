          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-linear-to-br from-dark-gradient-mid to-dark-gradient-end flex items-center justify-center">
            ...
            >
              ...
              <Card variant="default" className="p-6">
                <h3 className="text-dark-text font-semibold mb-4 flex items-center gap-2">
                  <span className="w-6 h-6 rounded-lg bg-dark-accent/10 flex items-center justify-center text-xs text-dark-accent font-bold">
                    ?
                  </span>
                  How to join
                </h3>
                <ol className="text-dark-muted text-sm space-y-4">
                  {[
                    ...
                    <li key={index} className="flex items-start gap-3">
                      <span className="w-5 h-5 rounded-full bg-dark-surface flex items-center justify-center text-xs text-dark-accent font-medium shrink-0 mt-0.5">
                        {index + 1}
                      </span>
                      <span>{step}</span>
                    </li>
              ...
              <Card variant="glass" className="p-5">
                <h4 className="text-dark-text font-medium mb-4">
                  Security Features
                </h4>
